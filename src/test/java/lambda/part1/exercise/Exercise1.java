...
class Exercise1 {
    ...
    void sortPersonsByLastNameThenFirstNameUsingArraysSortAnonymousComparator() {
        ...
        Arrays.sort(persons, new Comparator<Person>() {
            @Override
            public int compare(Person o1, Person o2) {
                int comparingByLastName = o1.getLastName().compareTo(o2.getLastName());
                return  comparingByLastName == 0 ? o1.getFirstName().compareTo(o2.getFirstName()) : comparingByLastName;
            }
        });
    ...
    void findFirstWithAge30UsingGuavaPredicate() {
        ...
        Person person = FluentIterable.from(persons).firstMatch(isFirstAge30).orNull();
