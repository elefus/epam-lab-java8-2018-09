...
class Exercise2 {
    ...
    void personHasNotEmptyLastNameAndFirstName() {
        ...
        Predicate<Person> validate = (person) -> {
            boolean checkNames = !Objects.isNull(person.getFirstName()) && !Objects.isNull(person.getLastName());
            return checkNames && (!person.getFirstName().isEmpty() && !person.getLastName().isEmpty());
        };
        ...
        assertThat(validate.test(new Person(null, "Мельников", 20)), is(false));
        assertThat(validate.test(new Person(null, null, 20)), is(false));
    }
    ...
    void personHasNotEmptyLastNameAndFirstNameUsingLogicalOperators() {
        Predicate<Person> personHasEmptyFirstName = person -> Objects.isNull(person.getFirstName()) || person.getFirstName().isEmpty();
        Predicate<Person> personHasEmptyLastName = person -> Objects.isNull(person.getLastName()) || person.getLastName().isEmpty();
        ...
        assertThat(personHasNotEmptyLastNameAndFirstName.test(new Person(null, "Мельников", 20)), is(false));
        assertThat(personHasNotEmptyLastNameAndFirstName.test(new Person(null, null, 20)), is(false));
