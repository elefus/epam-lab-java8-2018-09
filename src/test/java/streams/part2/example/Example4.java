...
//                                                                            .entrySet()
//                                                                            .stream()
//                                                                            .map(entry -> new PersonPositionDuration(employee
//                                                                                    .getPerson(), entry.getKey(), entry.getValue())))
//                                               .collect(groupingBy(PersonPositionDuration::getPosition, collectingAndThen(maxBy(comparingInt(PersonPositionDuration::getDuration)),
